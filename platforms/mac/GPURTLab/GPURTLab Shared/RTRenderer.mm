...
- (nonnull instancetype)initWithMetalKitView:(nonnull MTKView *)view;
{
    ...
    if (self) {
        ...
        Logger::GetLogger().info("Metal device: {}", _device.name.UTF8String);
        ...
        // create pipelines
        {
            ...
            if (!_rayPipeline) {
                Logger::GetLogger().error("Failed to create pipeline state: {}", error.localizedDescription.UTF8String);
            }
        ...
        // create scene
        {
            ...
            createCube(FACE_MASK_NEGATIVE_Y | FACE_MASK_POSITIVE_Y | FACE_MASK_NEGATIVE_Z, vector3(0.725f, 0.71f, 0.68f), transform, true,
